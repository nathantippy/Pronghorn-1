...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#T"><code>T</code></a>&gt; input: <em>Input that will be released until ready</em><br/><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#P"><code>P</code></a>&gt; output: <em>Pipe onto which the input will be released on</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#RawDataSchema"><code>RawDataSchema</code></a>&gt; input: <em>Pipe with RawDataSchema that will compares to the byte array</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#RawDataSchema"><code>RawDataSchema</code></a>&gt; output: <em>The pipe onto which the rawData byte array will be written to</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#ReleaseSchema"><code>ReleaseSchema</code></a>&gt; parseAck: <em>The release acknowledgment input pipes.</em><br/><br/></ul></td></tr><tr><th>Output</th><td>Pipe output: <em>The read payload from the socket.</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe input: <em>Payload that will be written to socket.</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#T"><code>T</code></a>&gt; input: <em>Pipe to be dumped</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#T"><code>T</code></a>&gt; input: <em>Any schema input pipe that should be summarized.</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#RawDataSchema"><code>RawDataSchema</code></a>&gt; output: <em>Pipe that file from inputPathString will be written to.</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#RawDataSchema"><code>RawDataSchema</code></a>&gt; input: <em>RawDataSchema that will be written  to file.</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#ClientHTTPRequestSchema"><code>ClientHTTPRequestSchema</code></a>&gt; input: <em>Multiple HTTP client requests</em><br/><br/></ul></td></tr><tr><th>Output</th><td>Pipe output: <em>Multiple net payload responses</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#NetResponseSchema"><code>NetResponseSchema</code></a>&gt; input: <em>The net response input pipe.</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#?"><code>?</code></a>&gt; observedRingBuffer: <em>observation pipes</em><br/><br/>Pipe notifyRingBuffer: <em>notify pipes</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#T"><code>T</code></a>&gt; output: <em>Does nothing.</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#T"><code>T</code></a>&gt; input: <em>Schema T input pipes that will be distributed</em><br/><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#T"><code>T</code></a>&gt; outputs: <em>Pipes on which the input pipe will be distributed on</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#NetPayloadSchema"><code>NetPayloadSchema</code></a>&gt; plainContent: <em>Plain content payload to be encrypted.</em><br/><br/></ul></td></tr><tr><th>Output</th><td>Pipe encryptedContent: <em>Encrypted payload.</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#ServerConnectionSchema"><code>ServerConnectionSchema</code></a>&gt; newClientConnections: <em>The ServerConnectionSchema containing the newest client information.</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#ReleaseSchema"><code>ReleaseSchema</code></a>&gt; ack: <em>The release acknowledgment.</em><br/><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#NetPayloadSchema"><code>NetPayloadSchema</code></a>&gt; output: <em>The read payload from the socket.</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe dataToSend: <em>The data to be written to the socket.</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#RawDataSchema"><code>RawDataSchema</code></a>&gt; output: <em>Writes the read tape directly back onto a RawDataSchema pipe.</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#T"><code>T</code></a>&gt; source: <em>The input pipe that will be written as a tape to disk.</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#RawDataSchema"><code>RawDataSchema</code></a>&gt; inputRing: <em>The RawDataSchema pipe that will be written to the output stream.</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; input: <em>Input pipe to be dumped
</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; output: <em>Valid JPG schema from BMP will be put onto this pipe
</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; input: <em>Input JPG schema that Forward DCT algorithm will be applied to.
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; input: <em>The JPG schema on which Huffman encoding will be applied to
</em><br/><br/></ul></td></tr><tr><th>Output</th><td><em>No output pipes</em><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; input: <em>Defined JPG schema
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; input: <em>Input JPG schema
...
<table><tr><th>Input</th><td><em>No input pipes</em><br/></ul></td></tr><tr><th>Output</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; output: <em>Output JPG schema
</em><br/><br/></td></tr></table>
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; input: <em>The JPG schema on which quantization will be applied to
...
<table><tr><th>Input</th><td>Pipe&lt;<a href="list-schemas#JPGSchema"><code>JPGSchema</code></a>&gt; input: <em>The JPG schema that is currently in RGB
